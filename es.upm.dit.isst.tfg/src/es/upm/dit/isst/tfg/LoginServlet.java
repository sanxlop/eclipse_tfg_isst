...
public class LoginServlet extends HttpServlet {
	public void doGet(HttpServletRequest req, HttpServletResponse resp)
		...
		/*
		 * UserService userService = UserServiceFactory.getUserService(); String
		 * url = userService.createLoginURL( req.getRequestURI()); String
		 * urlLinktext = "Login" ; resp.setContentType( "text/html" ); if (
		 * req.getUserPrincipal() != null ){ url = userService.createLogoutURL(
		 * req .getRequestURI()); urlLinktext = "Logout" ;
		 * resp.getWriter().println("<p>Hola" + req.getUserPrincipal().getName()
		 * + "</p>"); } resp.getWriter().println("<p>Pulsa <a href=" + url + ">"
		 * + urlLinktext + "</a></p>");
		 */
